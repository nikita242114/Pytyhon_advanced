...
class Matrix:
    ...
    def __add__(self, other):
        if len(self._matr) != len(other._matr) or len(self._matr[0]) != len(
            other._matr[0]
        ):
            logger.error(
            ...
            new_matr = Matrix(
                [
                    [
                        self._matr[i][j] + other._matr[i][j]
...
if __name__ == "__main__":
    ...
    m_1 = [[1, 2, 4], [5, 6, 8], [2, 5, -2], [10, 5, 0]]

    m_2 = [[1, 2, 4.5], [5, 6, 8], [5, 6, 8], [-2, 2, 0]]

    m_3 = [[1, 2, 4, 5, 6], [5, 6, 8, 0], [5, 0, -7, 1]]

    m_4 = [[1, 2, 4, 5, 0], [5, 6, 8, 0, 0], [5, 0, -7, 1, 0]]
